...
import { Box, VStack, Heading, Text, Image, HStack, Icon, Link, keyframes } from "@chakra-ui/react";
    ...
    <Box bg="gray.900" minH="100vh" p={8}>
      <VStack spacing={8} align="center" maxW="container.lg" mx="auto">
        ...
        <VStack align="stretch" spacing={4} maxW="xl">
          ...
          <Text color="white">
            Ik ben een fullstack JavaScript ontwikkelaar met ervaring in React, Node.js en moderne webontwikkeling. Ik houd ervan om uitdagende projecten aan te pakken en altijd nieuwe dingen te leren.
          </Text>
          </motion.div>
